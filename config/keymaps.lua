...
map("n", "<leader>th", function()
    require("config.other").toggle_term(2, "horizontal", 20)
end, desc("Terminal horizontal"))
map("n", "<leader>tv", function()
    require("config.other").toggle_term(3, "vertical", 75)
end, desc("Terminal vertical"))
map("n", "<A-d>", "<cmd>ToggleTerm<cr>", desc("Toggle terminal"))
map("n", "<leader>tl", "<cmd>TermSelect<cr>", desc("List terminals"))
map("t", "<A-d>", "<cmd>ToggleTerm<cr>", desc("Toggle terminal"))
-- 终端模式：Esc 退出到普通模式
